...
class dataset_detail_page extends StatefulWidget {
  const dataset_detail_page({Key? key}) : super(key: key);

  @override
  State<dataset_detail_page> createState() => _datasset_detail_pageState();
}

class _datasset_detail_pageState extends State<dataset_detail_page> {
  @override
  int _counter = 0;
  int currentIndex = 0;
